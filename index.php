...
<!---------end of the carousel ------------>
			...
			<div class="row">
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								<button type="button" class="btn btn-default" data-toggle="collapse" data-target="#in1">Description<span class='caret'></span></button>
				...
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								<button type="button" class="btn btn-default" data-toggle="collapse" data-target="#in2">Description<span class='caret'></span></button>
				...
				<div class="col-sm-4 slideanim">
					...
					<small>
						<button type="button" class="btn btn-default" data-toggle="collapse" data-target="#in3">Description<span class='caret'></span></button>
					...
					<div id="in3" class='collapse'> <!----collapse div -->
		...
		<div class="container bg" id="soft">
			...
			<div class="row">
				<div class="col-sm-6 slideanim ">
					...
					<div id="s1" class="collapse text-center"> <!----collapse div -->
									<small>
										<table class="table table-responsive table-striped table-bordered">
										<thead>
											<tr class="slideanim">
				...
				<div class="col-sm-6 slideanim">
					...
					<div class='text-center'>
						...
						<div id="s2" class="collapse text-center"> <!----collapse div -->	
								<small>
		...
		<footer class="text-center slideanim" id="bottom">
			...
			<div class="row" style="padding-top:5px">
				<div class="col-sm-4">
				<!--	<a href='tss/tss.php'>Start tss# contest</a> -->
				</div>
